...
<br>
    ...
    <br>
    <a href="cat_a_supervisor.php" class="btn btn-primary" style="border-radius: 5em;margin-left: 11em;"><i class="fa fa-arrow-right" ></i></a>
</div>
...
<br>
    ...
    <br>
    <a href="cat_b_supervisor.php" class="btn btn-success" style="border-radius: 5em;margin-left: 11em;"><i class="fa fa-arrow-right"></i></a>
</div>
...
<br>
    ...
    <br>
<a href="cat_c_supervisor.php" class="btn btn-primary" style="border-radius: 5em;margin-left: 11em;"><i class="fa fa-arrow-right"></i></a>
</div>
