...
if(isset($_POST['save'])){
   ...
   $school_unit= mysqli_real_escape_string($con, $_POST['school_unit']);
   $gimpa = mysqli_real_escape_string($con, $_POST['gimpa']);
   ...
   $lecturer_id= mysqli_real_escape_string($con, $_SESSION['sup_id']);
    $dept_id = $_SESSION['dept'];
        ...
        if(mysqli_query($con, "INSERT INTO cat_c(lecturer_id,role_id,academic_id,dept_id,school_unit,gimpa,community,profession,total_score,percentage_score,
          qualitative_rating,composition_of_weighted_score) VALUES('" . $lecturer_id . "', '" . $role_id . "', '" . $academic_yr . "', '" . $dept_id . "', '" . $school_unit . "', '" . $gimpa . "', '" . $community . "', '" . $profession . "', '" . $total_score . "', '" . $percentage_score . "', '" . $qualitative_rating . "', '" . $composition_of_weighted_score . "')")) {
...
<ul class="nav navbar-nav pull-left" style="padding-top: 0.5em">
    ...
    <div class="container" style="margin-top: 7em;">
 	...
 	<form id="cat_c_supervisor" name="cat_c_supervisor" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
