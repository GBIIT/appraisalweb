...
<div class="col-lg-4">
    ...
    <div class="col-lg-4">
     ...
     <select name="academic_yr" id="academic_yr" class="form-control" onchange="change()">       
...
$sql1 = "SELECT * from users as u INNER JOIN cat_a as a on u.lecturer_id=a.lecturer_id WHERE u.dept_id = '" . $_SESSION['dept'] . "' ";
$sql2 = "SELECT * from users as u INNER JOIN cat_b as b on u.lecturer_id=b.lecturer_id WHERE u.dept_id = '" . $_SESSION['dept'] . "' ";
$sql3 = "SELECT * from users as u INNER JOIN cat_c as c on u.lecturer_id=c.lecturer_id WHERE u.dept_id = '" . $_SESSION['dept'] . "' ";
...
<script>
function change(){
    document.getElementById("academic_yr").submit();
}
</script>
