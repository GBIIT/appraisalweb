...
$sql1 = "SELECT * from cat_a  WHERE lecturer_id = '" . $_SESSION['lec_id'] . "' ";
$sql2 = "SELECT * from cat_b  WHERE lecturer_id = '" . $_SESSION['lec_id'] . "' ";
$sql3 = "SELECT * from cat_c  WHERE lecturer_id = '" . $_SESSION['lec_id'] . "' ";
