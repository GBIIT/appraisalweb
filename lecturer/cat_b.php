...
if(isset($_POST['save'])){
   ...
   $dept_id = $_SESSION['dept'];
        ...
        if(mysqli_query($con, "INSERT INTO cat_b(lecturer_id,role_id,academic_yr,dept_id,a_ranking,b_ranking,c_ranking,d_ranking,refreed,conference,no_evidence,total_score,percentage_score) VALUES('" . $lecturer_id . "','" . $role_id . "','" . $academic_yr . "','" . $dept_id . "','" . $a_ranking . "', '" . $b_ranking . "', '" . $c_ranking . "', '" . $d_ranking . "', '" . $refreed . "', '" . $conference . "', '" . $no_evidence . "', '" . $total_score . "', '" . $percentage_score . "')")) {
...
?>
 ...
 <html>
  <head>
    ...
    <!-- Website Title & Description for Search Engine purposes -->
    <title>Research Publication and Scholarship</title>
...
<ul class="nav navbar-nav pull-left" style="padding-top: 0.5em">
    ...
    <div class="container" style="margin-top: 7em;">
 	...
 	<form id="cat_b" name="cat_b" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"/>
