...
$sql = "INSERT INTO workplan(lecturer_id,academic_yr,workplan) VALUES('$workplan','$academic_yr','$lecturer_id')";
...
<ul class="nav navbar-nav pull-left" style="padding-top: 0.5em">
  ...
  <div class="container" style="margin-top: 7em;">
    <p align="center" style="font-size: 1.5em; font-weight: bold">Enter your Workplan</p>
<form id="registration" name="registration" method="post" autocomplete="off" action="<?php echo $_SERVER['PHP_SELF']; ?>"/>
  ...
  <p>
    <label for="a_ranking">Lecturer ID</label>
    <input type="text" name="lecturer_id" id="lecturer_id" value="<?php echo $_SESSION['lec_id']; ?>" readonly class="form-control input-lg" style="width:20em;" />
  </p>
  <br>
  ...
  <div class="col-lg-6">
    ...
    <label for="refreed">Accademic Year</label>
...
<br>
  ...
  <textarea class="form-control" rows="5" name ="workplan" id="workplan"></textarea>
</div>
